...
import edu.ecopharmacy.nttdata.model.InventoryModel;
...
/**
 * The base model implementation for the Inventory service. Represents a row in the &quot;VC_Inventory&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class InventoryModelImpl
	 ...
	 */
	public static final String TABLE_NAME = "VC_Inventory";

	public static final Object[][] TABLE_COLUMNS = {
		{"inventoryId", Types.BIGINT}, {"groupId", Types.BIGINT},
		{"companyId", Types.BIGINT}, {"userId", Types.BIGINT},
		{"userName", Types.VARCHAR}, {"createDate", Types.TIMESTAMP},
		{"modifiedDate", Types.TIMESTAMP}, {"productId", Types.BIGINT},
		{"sedeId", Types.BIGINT}, {"stock", Types.INTEGER}
	};
	...
	public static final String TABLE_SQL_CREATE =
		"create table VC_Inventory (inventoryId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,productId LONG,sedeId LONG,stock INTEGER)";

	public static final String TABLE_SQL_DROP = "drop table VC_Inventory";

	public static final String ORDER_BY_JPQL =
		" ORDER BY inventory.inventoryId ASC";

	public static final String ORDER_BY_SQL =
		" ORDER BY VC_Inventory.inventoryId ASC";
	 ...
	 */
	@Deprecated
	public static final long INVENTORYID_COLUMN_BITMASK = 2L;
	...
	private static Function<InvocationHandler, Inventory>
		_getProxyProviderFunction() {

		Class<?> proxyClass = ProxyUtil.getProxyClass(
			Inventory.class.getClassLoader(), Inventory.class,
			ModelWrapper.class);

		try {
			Constructor<Inventory> constructor =
				(Constructor<Inventory>)proxyClass.getConstructor(
	...
	static {
		...
		attributeGetterFunctions.put("inventoryId", Inventory::getInventoryId);
		attributeSetterBiConsumers.put(
			"inventoryId",
			(BiConsumer<Inventory, Long>)Inventory::setInventoryId);
		attributeGetterFunctions.put("groupId", Inventory::getGroupId);
		attributeSetterBiConsumers.put(
			"groupId", (BiConsumer<Inventory, Long>)Inventory::setGroupId);
		attributeGetterFunctions.put("companyId", Inventory::getCompanyId);
		attributeSetterBiConsumers.put(
			"companyId", (BiConsumer<Inventory, Long>)Inventory::setCompanyId);
		attributeGetterFunctions.put("userId", Inventory::getUserId);
		attributeSetterBiConsumers.put(
			"userId", (BiConsumer<Inventory, Long>)Inventory::setUserId);
		attributeGetterFunctions.put("userName", Inventory::getUserName);
		attributeSetterBiConsumers.put(
			"userName", (BiConsumer<Inventory, String>)Inventory::setUserName);
		attributeGetterFunctions.put("createDate", Inventory::getCreateDate);
		attributeSetterBiConsumers.put(
			"createDate",
			(BiConsumer<Inventory, Date>)Inventory::setCreateDate);
		attributeGetterFunctions.put(
			"modifiedDate", Inventory::getModifiedDate);
		attributeSetterBiConsumers.put(
			"modifiedDate",
			(BiConsumer<Inventory, Date>)Inventory::setModifiedDate);
		attributeGetterFunctions.put("productId", Inventory::getProductId);
		attributeSetterBiConsumers.put(
			"productId", (BiConsumer<Inventory, Long>)Inventory::setProductId);
		attributeGetterFunctions.put("sedeId", Inventory::getSedeId);
		attributeSetterBiConsumers.put(
			"sedeId", (BiConsumer<Inventory, Long>)Inventory::setSedeId);
		attributeGetterFunctions.put("stock", Inventory::getStock);
		attributeSetterBiConsumers.put(
			"stock", (BiConsumer<Inventory, Integer>)Inventory::setStock);
	 ...
	 */
	@Deprecated
	public long getOriginalSedeId() {
		return GetterUtil.getLong(this.<Long>getColumnOriginalValue("sedeId"));
	}
	...
	public Object clone() {
		...
		inventoryImpl.setUserName(getUserName());
		...
		inventoryImpl.setSedeId(getSedeId());
		inventoryImpl.setStock(getStock());
	...
	public CacheModel<Inventory> toCacheModel() {
		...
		inventoryCacheModel.userName = getUserName();

		String userName = inventoryCacheModel.userName;

		if ((userName != null) && (userName.length() == 0)) {
			inventoryCacheModel.userName = null;
		}
		...
		inventoryCacheModel.sedeId = getSedeId();

		Integer stock = getStock();

		if (stock != null) {
			inventoryCacheModel.stock = stock;
		}
	...
	public String toString() {
		...
		for (Map.Entry<String, Function<Inventory, Object>> entry :
			...
			sb.append("=");
			sb.append(attributeGetterFunction.apply((Inventory)this));
			sb.append(", ");
		}
	...
	static {
		...
		columnBitmasks.put("productId", 128L);

		columnBitmasks.put("sedeId", 256L);
