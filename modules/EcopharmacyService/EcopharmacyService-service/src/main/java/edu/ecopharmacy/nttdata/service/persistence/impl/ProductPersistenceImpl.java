...
import edu.ecopharmacy.nttdata.exception.NoSuchProductException;
import edu.ecopharmacy.nttdata.model.Product;
import edu.ecopharmacy.nttdata.model.impl.ProductImpl;
import edu.ecopharmacy.nttdata.model.impl.ProductModelImpl;
...
public class ProductPersistenceImpl
	 ...
	 */
	@Override
	public List<Product> findByProductName(String name, int start, int end) {
	...
	public Product findByProductName_First(
		...
		Product product = fetchByProductName_First(name, orderByComparator);
	...
	public Product fetchByProductName_First(
		...
		List<Product> list = findByProductName(name, 0, 1, orderByComparator);
	...
	public Product findByProductName_Last(
		...
		Product product = fetchByProductName_Last(name, orderByComparator);
