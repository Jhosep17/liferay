...
public class CategoryLocalServiceWrapper
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Category addCategory(
		edu.ecopharmacy.nttdata.model.Category category) {
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Category createCategory(
		long categoryId) {
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Category deleteCategory(
		edu.ecopharmacy.nttdata.model.Category category) {
	...
	@Override
	public edu.ecopharmacy.nttdata.model.Category fetchCategory(
		long categoryId) {
	 ...
	 */
	@Override
	public java.util.List<edu.ecopharmacy.nttdata.model.Category> getCategories(
		int start, int end) {
	...
	@Override
	public java.util.List<edu.ecopharmacy.nttdata.model.Category>
		getCategoriesAll() {

		return _categoryLocalService.getCategoriesAll();
	}
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Category getCategory(long categoryId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Category updateCategory(
		edu.ecopharmacy.nttdata.model.Category category) {
