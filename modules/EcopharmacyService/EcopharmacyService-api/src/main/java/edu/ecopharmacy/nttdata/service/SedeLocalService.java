...
public interface SedeLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>edu.ecopharmacy.nttdata.service.impl.SedeLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the sede local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link SedeLocalServiceUtil} if injection and service tracking are not available.
	 */
