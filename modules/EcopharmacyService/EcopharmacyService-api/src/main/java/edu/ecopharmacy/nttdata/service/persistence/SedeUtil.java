...
public class SedeUtil {
	 ...
	 * @return the new sede
	 */
	public static Sede create(long sedeId) {
		return getPersistence().create(sedeId);
	}
	 ...
	 */
	public static Sede remove(long sedeId)
		throws edu.ecopharmacy.nttdata.exception.NoSuchSedeException {

		return getPersistence().remove(sedeId);
	}
	 ...
	 * @throws NoSuchSedeException if a sede with the primary key could not be found
	 */
	public static Sede findByPrimaryKey(long sedeId)
		throws edu.ecopharmacy.nttdata.exception.NoSuchSedeException {

		return getPersistence().findByPrimaryKey(sedeId);
	}
	 ...
	 */
	public static Sede fetchByPrimaryKey(long sedeId) {
		return getPersistence().fetchByPrimaryKey(sedeId);
	}
