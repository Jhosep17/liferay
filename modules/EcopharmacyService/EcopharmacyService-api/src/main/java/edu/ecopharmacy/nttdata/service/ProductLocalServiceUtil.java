 ...
 * <code>edu.ecopharmacy.nttdata.service.impl.ProductLocalServiceImpl</code> and
...
public class ProductLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>edu.ecopharmacy.nttdata.service.impl.ProductLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	...
	public static List<Product> getListProduct(String name) {
		return getService().getListProduct(name);
	}
