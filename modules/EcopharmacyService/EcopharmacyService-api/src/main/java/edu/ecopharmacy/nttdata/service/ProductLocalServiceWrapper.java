...
public class ProductLocalServiceWrapper
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Product addProduct(
		edu.ecopharmacy.nttdata.model.Product product) {
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Product createProduct(long productId) {
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Product deleteProduct(long productId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Product deleteProduct(
		edu.ecopharmacy.nttdata.model.Product product) {
	...
	@Override
	public edu.ecopharmacy.nttdata.model.Product fetchProduct(long productId) {
	...
	@Override
	public java.util.List<edu.ecopharmacy.nttdata.model.Product> getListProduct(
		String name) {

		return _productLocalService.getListProduct(name);
	}
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Product getProduct(long productId)
		throws com.liferay.portal.kernel.exception.PortalException {
	 ...
	 */
	@Override
	public java.util.List<edu.ecopharmacy.nttdata.model.Product> getProducts(
		int start, int end) {
	 ...
	 */
	@Override
	public edu.ecopharmacy.nttdata.model.Product updateProduct(
		edu.ecopharmacy.nttdata.model.Product product) {
